...
function PlaylistIcon(props) {
  // console.log('props',props.onIconPress)

  return (
    <Pressable onPress={props.onMusicIconPress}>
      <Svg
        width={24}
        height={24}
        viewBox="0 0 24 24"
        ...
        // onClick={async()=>await props.onIconPress()}
        {...props}>
        <G stroke={props.Color} strokeWidth={1.5}>
          <Path
            d="M18.4 5.6H4.8M8.8 13.6h-4M12 9.6H4.8"
            strokeLinecap="round"
          />
